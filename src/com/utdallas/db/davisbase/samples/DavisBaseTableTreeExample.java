package com.utdallas.db.davisbase.samples;
...
public class DavisBaseTableTreeExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			binaryFile.setLength(0); // Initialize the file size to be zero (in
										// case it already exists)
			binaryFile.setLength(pageSize * 3); // Set the file size to be three
												// pages in length
			/**
			 * Define page 1
			 */
			...
			binaryFile.seek(page1start); // Move the address pointer to the
											// beginning of Page 1, i.e table
											// tree root
			binaryFile.writeByte(0x05); // The first page is a table interior
										// page
			binaryFile.writeByte(0x01); // Number of cells on this page
			binaryFile.writeShort(0x01F8); // offset address of start of content
											// area
			binaryFile.writeInt(3); // A pointer to the rightmost child page
									// (4‐byte INT)
			...
			binaryFile.writeInt(2); // A pointer to the subtree <or = to the
									// first key
			...
			binaryFile.seek(page2start); // Move the address pointer to the
											// beginning of the Page 2
			binaryFile.writeByte(0x0D); // The first page is a table interior
										// page
			binaryFile.writeByte(0x03); // Number of cells on this page
			binaryFile.writeShort(0x01BD); // offset address of start of content
											// area
			/* The array of cell locations */
			...
			binaryFile.seek(page2start + 0x1E8); // Offset address to begin
													// writing record rowid=1
			binaryFile.writeShort(18); // Size of payload
			binaryFile.writeInt(1); // rowid=1 (is also column_1)
			binaryFile.writeByte(3); // number of columns in addition to rowid
										// column_1
			binaryFile.writeByte(5); // column_2 data type byte SMALLINT 2‐ byte
										// integer
			binaryFile.writeByte(8); // column_3 data type byte REAL 4‐byte
										// single precision float
			binaryFile.writeByte(20); // column_4 data type byte STRING 12B + 8
										// ASCII characters
			...
			binaryFile.seek(page2start + 0x1D2); // Offset address to begin
													// writing record rowid=1
			...
			binaryFile.writeByte(8); // column_3 data type byte REAL 4‐byte
										// single precision float
			binaryFile.writeByte(18); // column_4 data type byte STRING 12B + 8
										// ASCII characters
			...
			binaryFile.seek(page2start + 0x1BD); // Offset address to begin
													// writing record rowid=1
			...
			binaryFile.writeByte(8); // column_3 data type byte REAL 4‐byte
										// single precision float
			binaryFile.writeByte(17); // column_4 data type byte STRING 12B + 8
										// ASCII characters
			...
			binaryFile.seek(page3start); // Move the address pointer to the
											// beginning of the Page 2
			binaryFile.writeByte(0x0D); // The first page is a table interior
										// page
			binaryFile.writeByte(0x03); // Number of cells on this page
			binaryFile.writeShort(0x01C0); // offset address of start of content
											// area
			/* The array of cell locations */
			...
			binaryFile.seek(page3start + 0x1EC); // Offset address to begin
													// writing record rowid=1
			binaryFile.writeShort(14); // Size of payload
			...
			binaryFile.writeByte(8); // column_3 data type byte REAL 4‐byte
										// single precision float
			binaryFile.writeByte(16); // column_4 data type byte STRING 12B + 8
										// ASCII characters
			...
			binaryFile.seek(page3start + 0x1D6); // Offset address to begin
													// writing record rowid=1
			binaryFile.writeShort(15); // Size of payload
			...
			binaryFile.seek(page3start + 0x1C0); // Offset address to begin
													// writing record rowid=1
			binaryFile.writeShort(15); // Size of payload
